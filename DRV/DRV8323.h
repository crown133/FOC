...
///PIN define
#define  GPIO_CS_CLK_EN()       __HAL_RCC_GPIOC_CLK_ENABLE()  //CS PIN
#define  GPIO_PIN_CS            GPIO_PIN_7
#define  GPIO_CS                GPIOC
#define  SPIDRV_CS_ENABLE()	    PCout(7) = 0
#define  SPIDRV_CS_DISABLE()	PCout(7) = 1

#define  GPIO_DRVEN_CLK_EN()    __HAL_RCC_GPIOC_CLK_ENABLE()  //Driver Enable PIN
#define  GPIO_PIN_DRVEN         GPIO_PIN_6
#define  GPIO_DRVEN             GPIOC
#define  DRIVER_ENABLE()        PCout(6) = 1
#define  DRIVER_DISABLE()       PCout(6) = 0

///SPI Define
#define  SPIDRV_INIT()          MX_SPI1_Init()
#define  hspidrv                hspi1
#define  SPIDRV                 SPI1

/// Registers ///
#define FSReg1              0x0     /// Fault Status Register 1
#define FSReg2              0x1     /// Fault Status Register 2
#define DCReg               0x2     /// Drive Control Register
#define HSReg               0x3     /// Gate Drive HS Register 
#define LSReg               0x4     /// Gate Drive LS Register  
#define OCPCReg             0x5     /// OCP Control Register    
#define CSACReg             0x6     /// CSA Control Register    
